...
git clone --depth=1 --branch 0.35.0 https://github.com/tonlabs/ton-q-server.git $DIR_DISTR/$DIR_TON_Q_SERVER
...
################TON-CLIENT-JS#############
git clone --depth=1 --branch 1.11.1 https://github.com/tonlabs/ton-client-js.git $DIR_DISTR/ton-client-js
